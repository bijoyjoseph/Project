    ...
    private void editData(final HashMap<String, String> stringStringHashMap, final int action) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                post.put(Const.FbConst.ADDRESS, stringStringHashMap.get(Const.FbConst.ADDRESS));
                post.put(Const.FbConst.EMAIL, stringStringHashMap.get(Const.FbConst.EMAIL));
                post.put(Const.FbConst.GENDER, stringStringHashMap.get(Const.FbConst.GENDER));
                post.put(Const.FbConst.OCCUPATION, stringStringHashMap.get(Const.FbConst.OCCUPATION));
                post.put(Const.FbConst.ANNUAL_INCOME, stringStringHashMap.get(Const.FbConst.ANNUAL_INCOME));
