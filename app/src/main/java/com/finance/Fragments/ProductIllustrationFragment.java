 ...
 */
public class ProductIllustrationFragment extends Fragment implements View.OnClickListener {
    ...
    private void initUi(View view){
        ...
        rvProductIllustrationList.setAdapter(new ProductIllustrationAdapter(this));
    }

    @Override
    public void onClick(View v) {
        Intent intent = new Intent(getActivity(), ProductIllustrationActivity.class);
