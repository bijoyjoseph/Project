 ...
 */
public class SubScriptionDetailFragment extends Fragment implements View.OnClickListener {
    ...
    private void initUi(View view) {
        ...
        firebaseRef = new Firebase(getResources().getString(R.string.cloud_url) + "/" + Const.FbConst.SUBSCRIPTION);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                requestListAdapter.setCallVisisblity(false);
...
//       editData(maps.get(position));
                setDetailScreen("Name :" + maps.get(position).get(Const.FbConst.NAME) + "\n"
                        + "Age :" + maps.get(position).get(Const.FbConst.AGE) + "\n"
                        + "Nominee name :" + maps.get(position).get(Const.FbConst.NOMINEE_NAME) + "\n"
                        + "Nominee age :" + maps.get(position).get(Const.FbConst.NOMINEE_AGE) + "\n"
                        + "Occupation :" + maps.get(position).get(Const.FbConst.OCCUPATION) + "\n"
                        + "Gender :" + maps.get(position).get(Const.FbConst.GENDER) + "\n"
                        + "Amount paid :" + maps.get(position).get(Const.FbConst.AMOUNT_PAID) + "\n"
                        + "Number :" + maps.get(position).get(Const.FbConst.NUMBER) + "\n"
                        + "ID :" + maps.get(position).get(Const.FbConst.POLICY_NUMBER) + "\n"
                        + "Product type :" + maps.get(position).get(Const.FbConst.POLICY_TYPE) + "\n"
                        + "Product frequency :" + maps.get(position).get(Const.FbConst.POLICY_FREQUENCY) + "\n"
                        + "Date :" + maps.get(position).get(Const.FbConst.DATE) + "\n"
                        + "Email :" + maps.get(position).get(Const.FbConst.EMAIL) + "\n"
                        + "Address :" + maps.get(position).get(Const.FbConst.ADDRESS) + "\n"
