 ...
 */
public class ProductIllustrationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProductIllustrationAdapter(View.OnClickListener listener) {
